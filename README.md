...
This is an example Android app for learning the Espresso testing framework, created as part of the [Android Developer Nanodegree by Google](https://www.udacity.com/course/android-developer-nanodegree-by-google--nd801). A user orders tea from a small business, to ensure the app meets design requirements various UI tests are implemented on views, intents, adpaters, and IdlingResources.
